        ...
        <div className="relative w-full flex flex-col rounded-3xl bg-[url('/n_w2.jpeg')] bg-cover bg-center bg-no-repeat">
            ...
            <div className=" bg-gradient-to-r from-white via-amber-50/50 to-white rounded-b-3xl border border-amber-200 px-4 pb-4 shadow-lg ">
                <div className="relative z-10">
                    ...
                    <div className="relative flex justify-between text-2xl font-tangerine text-violet-950 pt-3 mb-1">
                        {/* <p className="z-10">Nana Serwaa</p> */}
                        <div className="absolute inset-5 flex justify-center items-center ml-5">
